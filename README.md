...
Starting with Weasel `0.5.0`, you will need at least ClojureScript version
`0.0-2665` and Piggieback version `0.1.4`.  You may want to use Piggieback
version `0.1.5-SNAPSHOT` or newer, however, as it fixes a number of bugs
related to the new ClojureScript REPL APIs.
